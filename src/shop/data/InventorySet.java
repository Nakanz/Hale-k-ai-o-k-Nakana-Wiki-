...
final class InventorySet implements Inventory {
  ...
  Record checkOut(Video video) {
    // TODO  
	  ...
	  _data.replace(video, 
			  new RecordObj(video, recordObj.numOwned, recordObj.numOut, recordObj.numRentals));
	  return prevRecord;
  }
...
//		  previousInventory.put(r.video(), new RecordObj(r.video(), r.numOwned(), r.numOut(), r.numRentals()).copy());
//	  }
	 _data.clear();
