...
class Control {
	...
	private void addSTART(int stateNum) {
		...
		m.add("Default", new UIMenuAction() {
			public void run() {
				_ui.displayError("Please enter a number corresponding to your desired action");
			}
		});
		...
		m.add("Check out a video", new UIMenuAction() {
			public void run() {
				// TODO
				String[] res1 = _ui.processForm(_getVideoForm);
				Command c = Data.newOutCmd(_inventory, Data.newVideo(res1[0], Integer.parseInt(res1[1]), res1[2]));
				if (!c.run()) {
					_ui.displayError("Command failed");
				}
			...
			public void run() {
				...
				Comparator<Record> comparator = new Comparator<Record>() {
					...
					public int compare(Record o1, Record o2) {
						...
						if (o1.numRentals() < o2.numRentals())
							return 1;
						else if (o1.numRentals() > o2.numRentals())
							return -1;
						return 0;
					}
				};
				Iterator<Record> iterator = _inventory.iterator(comparator);
				Record record = iterator.next();
				String topRentalRecords = "Error! Inventory is empty...";
				if (record != null) {
					topRentalRecords = "Top Ten All Time Rentals:\n\n";
					for (int rank = 1; rank<11; rank++) {
						topRentalRecords += "Rank " + rank + " \n\t<" + (!(record.numRentals() > 0) ? "N/A> \n\n" : record.toString()  + ">\n" 
								+ "     Number of Rentals: " + record.numRentals()+ "\n\n");
						record = iterator.next();
					}
					_ui.displayMessage(topRentalRecords);
				} else {
					_ui.displayError(topRentalRecords);
				}
		...
		m.add("Initialize with bogus contents", new UIMenuAction() {
			// 26 videos of copy size i++ where i<27 && i != 0
			public void run() {
				...
				// -- top ten rentals TEST BEGIN
//				Data.newOutCmd(_inventory, Data.newVideo("z", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("z", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("z", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("z", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("z", 2000, "m")).run();
...
//				Data.newOutCmd(_inventory, Data.newVideo("z", 2000, "m")).run();
//
//				Data.newInCmd(_inventory, Data.newVideo("z", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("z", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("z", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("z", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("z", 2000, "m")).run();
...
//				Data.newInCmd(_inventory, Data.newVideo("z", 2000, "m")).run();
//
//				Data.newOutCmd(_inventory, Data.newVideo("y", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("y", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("y", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("y", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("y", 2000, "m")).run();
...
//				Data.newOutCmd(_inventory, Data.newVideo("y", 2000, "m")).run();
//
//				Data.newInCmd(_inventory, Data.newVideo("y", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("y", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("y", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("y", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("y", 2000, "m")).run();
...
//				Data.newInCmd(_inventory, Data.newVideo("y", 2000, "m")).run();
//
//				Data.newOutCmd(_inventory, Data.newVideo("x", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("x", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("x", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("x", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("x", 2000, "m")).run();
...
//				Data.newOutCmd(_inventory, Data.newVideo("x", 2000, "m")).run();
//
//				Data.newInCmd(_inventory, Data.newVideo("x", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("x", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("x", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("x", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("x", 2000, "m")).run();
...
//				Data.newInCmd(_inventory, Data.newVideo("x", 2000, "m")).run();
//
//				Data.newOutCmd(_inventory, Data.newVideo("a", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("a", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("a", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("a", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("a", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("a", 2000, "m")).run();
...
//				Data.newInCmd(_inventory, Data.newVideo("a", 2000, "m")).run();
//
//				Data.newOutCmd(_inventory, Data.newVideo("b", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("b", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("b", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("b", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("b", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("b", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("b", 2000, "m")).run();
...
//				Data.newInCmd(_inventory, Data.newVideo("b", 2000, "m")).run();
//
//				Data.newOutCmd(_inventory, Data.newVideo("j", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("j", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("j", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("j", 2000, "m")).run();
//
//				Data.newOutCmd(_inventory, Data.newVideo("j", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("j", 2000, "m")).run();
...
//				Data.newOutCmd(_inventory, Data.newVideo("j", 2000, "m")).run();
//
//				Data.newOutCmd(_inventory, Data.newVideo("h", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("h", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("h", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("h", 2000, "m")).run();
//				Data.newOutCmd(_inventory, Data.newVideo("h", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("h", 2000, "m")).run();
...
//				Data.newOutCmd(_inventory, Data.newVideo("h", 2000, "m")).run();
//				Data.newInCmd(_inventory, Data.newVideo("h", 2000, "m")).run();
				// -- top ten rentals TEST END

			}
		});

		_menus[stateNum] = m.toUIMenu("Hale kūʻai o kō Nakana Wikiō\n     (Nakana's video store)\n");
	}
